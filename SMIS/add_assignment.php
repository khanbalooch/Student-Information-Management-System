...
<div id = "wraper">
  ...
  <div id = "content">
    <h1 id = "coursehead">New Assignment</h1>
...
<form action="add_assignment.php" method="post" name="form10"><br />
...
//	  echo $_POST[ass_id];  echo '<br/>';
	...
	$sql_insert="INSERT INTO assignment (ass_id,course_id,sem_id,sec_name,ass_marks,ass_wtg,ass_open_date,ass_due_date,ass_desc) VALUES($_POST[ass_id],'".$course_id."','".$semester_id."','$_POST[selectsection]',$_POST[ass_mk],$_POST[ass_wt],'".date('d-M-Y')."','$_POST[ass_d_date]','$_POST[ass_desc]')";
...
Assignment No<input type="number" name="ass_id" value=""/><br/>
...
<form action="add_assignment.php" method="post" name="form15" >
...
if($_POST["show_all"]=='Show All'){
	...
	$sql_select="select q.ass_id,c.course_name,s.sem_id,q.sec_name,q.ass_marks,q.ass_wtg,q.ass_due_date,q.ass_open_date
	 from assignment q,course c,semester s,section sc
	...
	<tr>
    <th scope="col">ASS_ID&nbsp;</th>
    <th scope="col">COURSE_NAME&nbsp;</th>
	<th scope="col">SEM_ID&nbsp;</th>
    <th scope="col">SEC_NAME&nbsp;</th>
    <th scope="col">ASS_MARKS&nbsp;</th>
    <th scope="col">ASS_WTG&nbsp;</th>
    <th scope="col">ASS_DUE_DATE&nbsp;</th>
	<th scope="col">ASS_OPEN_DATE&nbsp;</th>
    </tr>';
	...
	while($row = oci_fetch_array($selectquery, OCI_BOTH+OCI_RETURN_NULLS))  //parse or execute for update, insert
	{
		...
		//echo 'fetching_array';
		echo '<tr>
		<td scope="col">'.$row["ASS_ID"].'&nbsp;</td>
		<td scope="col">'.$row["COURSE_NAME"].'&nbsp;</td>
		<td scope="col">'.$row["SEM_ID"].'&nbsp;</td>
		<td scope="col">'.$row["SEC_NAME"].'&nbsp;</td>
		<td scope="col">'.$row["ASS_MARKS"].'&nbsp;</td>
		<td scope="col">'.$row["ASS_WTG"].'&nbsp;</td>
		<td scope="col">'.$row["ASS_DUE_DATE"].'&nbsp;</td>
		<td scope="col">'.$row["ASS_OPEN_DATE"].'&nbsp;</td>
		</tr>';
		}
		echo '</table>';
