...
echo "$user_id";
   ...
   $con = oci_connect($db_user,$db_pass,$db_sid);
	...
	$_select = "select es.passwd,e.stu_name 
				from stu_users es, student e 
				where es.passwd = '".$old_pass."' 
				and es.usr_id = e.stu_id
				and e.stu_id = '".$user_id."'";
...
<div id = "wraper">
	...
	<div id = "content">
   	        	<form id = "form" action="stu_passreset.php" method="post" name="form1">
    ...
    <form action="student.php" method="post" name="form15" >
